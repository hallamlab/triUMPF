...
The three E.coli genomes can be access from [here](src/sample). The indices correspond: 0 to Escherichia coli CFT073, 1 to Escherichia coli O157:H7 str. EDL933, and 2 to Escherichia coli str. MG1655:
    ...
    - "biocyc_ecoli_triumpf_y.pkl": three E.coli data of size (3, 2526).
    - "biocyc_ecoli_taxprune_pathologic_y.pkl": three E.coli data of size (3, 2526).
    - "biocyc_ecoli_notaxprune_pathologic_y.pkl": three E.coli data of size (3, 2526).
